...
class TestIntegration:
    ...
    def test_list_tools_endpoint(self, mock_tool_registry):
        ...
        mock_tool_registry.list_tools.return_value = [
            {"name": "tool1", "description": "Tool 1", "category": "Test", "has_parameters": False},
            {"name": "tool2", "description": "Tool 2", "category": "Custom", "has_parameters": True}
        ]
    ...
    def test_create_tool_duplicate_name(self, mock_tool_registry):
        ...
        mock_tool_registry.add_tool.side_effect = ValueError("Tool with name 'existing_tool' already exists")
...
class TestEndToEndWorkflow:
    ...
    def test_complete_workflow(self, mock_agent, mock_tool_registry):
        ...
        mock_tool_registry.list_tools.return_value = [
            {"name": "custom_analysis", "description": "Custom analysis tool", "category": "Custom", "has_parameters": False}
        ]
